<?php $__env->startSection('konten'); ?>
	...
	<script>
		...
		var appVue = new Vue({
			...
			mounted() {
				this.url = "<?php echo e(url('get_product')); ?>"
				this.getData();
			},
			methods: {
				getData: function() {
				...
				simpanproduk: function() {
					...
					var url = "<?php echo e(url('saveproduk')); ?>";
				...
				editData: function(id) {
					...
					var url = "<?php echo e(url('get_produkById')); ?>" + '/' + id;
				...
				hapusData: function(id) {
					var url = "<?php echo e(url('hapus_produk')); ?>" + '/' + id;
					axios.get(url)
						.then(resp => {
							console.log(resp);
							this.getData();
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\data_utama\resources\views/produk.blade.php ENDPATH**/ ?>