<?php $__env->startSection('konten'); ?>
	...
	<script>
		...
		var appVue = new Vue({
			...
			mounted() {
				this.url = "<?php echo e(url('get_transaksi')); ?>"
				this.getData();
			},
			methods: {
				getData: function() {
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\data_utama\resources\views/transaksi.blade.php ENDPATH**/ ?>